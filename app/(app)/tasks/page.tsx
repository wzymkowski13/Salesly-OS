...
export default async function TasksPage() {
  ...
  const newTaskForm = <form action={createTask} data-salesly-create="task" className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
    ...
    <div className="md:col-span-2 xl:col-span-3"><label className="mb-1.5 block text-xs font-semibold text-[#6f7d89]">Opis</label><Textarea name="description" placeholder="Kontekst lub ustalenia"/></div>
    <div className="md:col-span-2 xl:col-span-3 flex justify-end"><Button type="submit">Dodaj zadanie</Button></div>
  </form>;
