...
export function MobileNav() {
  ...
  return <nav className="fixed inset-x-3 bottom-3 z-50 grid grid-cols-5 rounded-2xl border border-[#dbe3ec] bg-white/95 px-1.5 py-1.5 shadow-[0_14px_42px_rgba(31,48,65,.16)] backdrop-blur lg:hidden">
